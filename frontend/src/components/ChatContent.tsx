  ...
  return (
    <>
      {messages.map((message, index) =>
        message.type === "user" ? (
          <div className="w-full text-[#ececec]" key={index}>
                  ...
                  <div className="flex-col gap-1 md:gap-3">
                    <div className="flex max-w-full flex-grow flex-col">
                      <div
                        ...
                        data-message-id="94f083cb-c026-4652-8bc4-06744e239d4e"
                    ...
                    <div className="mt-1 flex justify-start gap-3 empty:hidden">
                      <div className="text-gray-400 visible -ml-1 mt-0 flex h-7 items-center justify-center gap-[2px] self-end lg:justify-start lg:self-center">
                        <button className="rounded-md p-1 text-[#9b9b9b] hover:text-[#ececec] md:invisible md:group-hover:visible md:group-[.final-completion]:visible">
          ...
          <div className="w-full text-[#ececec]" key={index}>
            <div className="m-auto justify-center px-4 py-2 text-base md:gap-6">
              <div className="group mx-auto flex flex-1 gap-3 text-base md:max-w-3xl md:px-5 lg:max-w-[40rem] lg:px-1 xl:max-w-[48rem] xl:px-5">
                ...
                <div className="relative flex w-full flex-col">
                  <div className="select-none font-semibold">ChatAIO</div>
                  <div className="flex-col gap-1 md:gap-3">
                    <div className="flex max-w-full flex-grow flex-col">
                      <div
                        data-message-author-role="assistant"
                        data-message-id="2799c647-ed0d-4503-8b5d-3f01945d81b6"
                        className="text-message flex min-h-[20px] flex-col items-start gap-3 overflow-x-auto whitespace-pre-wrap break-words [.text-message+&]:mt-5"
                      >
                    ...
                    <div className="mt-1 flex justify-start gap-3 empty:hidden">
                      <div className="text-gray-400 visible -ml-1 mt-0 flex h-7 items-center justify-center gap-[2px] self-end lg:justify-start lg:self-center">
                        <span data-state="closed">
                          <button className="flex items-center gap-1.5 rounded-md p-1 text-xs text-[#9b9b9b] hover:text-[#ececec] md:invisible md:group-hover:visible md:group-[.final-completion]:visible">
                            <svg
                              width="24"
                              height="24"
                              viewBox="0 0 24 24"
